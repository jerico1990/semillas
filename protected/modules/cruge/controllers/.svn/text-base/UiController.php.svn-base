            ...
            if ($model->validate()) {
                if ($model->login(false) == true) {
                    ...
                    //$this->redirect(Yii::app()->user->returnUrl);
                        ...
                        {
                            $this->redirect(array('/iform/aindex'));
                        }
                        elseif(Yii::app()->user->checkAccess('inspector'))
                        {
                            $this->redirect(array('/iform/iindex'));
                        }
                        elseif(Yii::app()->user->checkAccess('productor'))
                        {
                            $this->redirect(array('/iform/index'));
                        }   
                        elseif(Yii::app()->user->checkAccess('peas'))
                        {
                            $this->redirect(array('/user/cuenta'));
                        }
                        elseif(Yii::app()->user->checkAccess('laboratorio'))
                        {
                            $this->redirect(array('/iform/laboratorio'));
                        }
                         
                        elseif(Yii::app()->user->checkAccess('pagador'))
                        {
                            $this->redirect(array('/payment/ValidaInia'));
                        }
