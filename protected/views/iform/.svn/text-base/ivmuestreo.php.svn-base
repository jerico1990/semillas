			...
			<div class="row-fluid span12">
				 <div class="span12">
					 ...
					 <?php
							...
							if($muestreo!==null)
							{
								$step.='<li style="background: #8DC641;" class="active"><span class="badge"></span>'.CHtml::link("Muestreo",array('ivmuestreo', 'id'=>$model->id)).'<span class="chevron"></span></li>';
							}
							if($etiquetado!==null)
							{
...
foreach($muestreos as $muestreo):
	if(Yii::app()->user->checkAccess('inspector'))
				...
				echo "<div class='row-fluid'>
							<div class='span6'><b>Codigo de Lote:</b> ".CHtml::AjaxLink("$muestreo->codigo_lote",array('iform/PupdateMuestreo','id'=>$muestreo->id),array('update' => '#data'))."</div>
							<div class='span6'></div>						
						</div>";
				}
endforeach;?>
