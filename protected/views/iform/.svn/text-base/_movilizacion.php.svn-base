...
<div class="row-fluid well span12">			  
		  ...
		  <div class="row-fluid">
				 <div class="span12">
					 <?php echo CHtml::link($data->form_number,array('movilizacion/create', 'id'=>$data->id)); ?>
					<?php //$this->widget('bootstrap.widgets.TbButton', array('buttonType'=>'link','size'=>'small','type'=>'primary', 'label'=>$data->id,'url'=>array('movilizacion/create', 'id'=>$data->id)));  ?>		
				 </div>
		  </div>
		  <div class="row-fluid">		 
					 <div class="span7">
