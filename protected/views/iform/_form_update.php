	...
	<h2>Semilla a Producir</h2>
		...
		<div class="span6">
			...
			<?php foreach($cultivos as $cultivo){ ?>
			    <option value="<?= $cultivo->id ?>" <?= ($model->crop_id==$cultivo->id)?'selected':'';?>><?= $cultivo->name ?></option>
			<?php } ?>
		    </select>
		...
		<div class="span6">
			...
			<option value>seleccionar</option>
			<?php foreach($cultivos as $cultivo){ ?>
			    <option value="<?= $cultivo->id ?>" <?= ($model->crop_before_id==$cultivo->id)?'selected':'';?>><?= $cultivo->name ?></option>
			<?php } ?>
		    </select>
	...
	<div class="tab-content">
		...
		<div class="row-fluid">
			...
			<select name="Iform[headquarter_id]" id="Iform_headquarter_id" onchange="Region($(this).val())">
				...
				<option value="<?= $ambito->id ?>" <?= ($ambito->id==$model->headquarter_id)?'selected':'';?>><?= $ambito->name ?></option>
			    <?php } ?>
			</select>
