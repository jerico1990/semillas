							...
							$this->widget('bootstrap.widgets.TbMenu', array(
								...
								'items' => array(
									...
									array(
										...
										'url' => '/peas/payment/notapago',
										'visible' => !Yii::app()->user->isGuest && (Yii::app()->user->checkAccess('productor'))
									),
									array(
										'label' => 'Historial pagos realizados',
										'url' => '/peas/payment/pagos',
										'visible' => !Yii::app()->user->isGuest && (Yii::app()->user->checkAccess('productor'))
									),							
									...
									array(
										'label' => 'Productores',
										'icon' => 'icon-chevron-right',
										'url' => '/peas/user/cuenta',
										'visible' => !Yii::app()->user->isGuest && Yii::app()->user->checkAccess('peas')
									),
									array(
										'label' => 'Productores E.E.',
										'icon' => 'icon-chevron-right',
										'url' => '/peas/user/iadmin',
										'visible' => !Yii::app()->user->isGuest && Yii::app()->user->checkAccess('peas')
									),
									array(
										'label' => 'Inspector',
										'icon' => 'icon-chevron-right',
										'url' => '/peas/inspector/admin',
										'visible' => !Yii::app()->user->isGuest && Yii::app()->user->checkAccess('peas')
									),
									array(
										'label' => 'Registros',										
									...
									array(
										'label' => 'O.C / E.E',
										'icon' => 'icon-chevron-right',
										'url' => '/peas/headquarter/admin',
										'visible' => !Yii::app()->user->isGuest && Yii::app()->user->checkAccess('peas')
									),
									array(
										'label' => 'Ambito',
										'icon' => 'icon-chevron-right',
										'url' => '/peas/headquarter/admin_ambito',
										'visible' => !Yii::app()->user->isGuest && Yii::app()->user->checkAccess('peas')
									),
									array(
										'label' => 'Plantas',
										'icon' => 'icon-chevron-right',
										'url' => '/peas/plantas/admin',
										'visible' => !Yii::app()->user->isGuest && Yii::app()->user->checkAccess('peas')
									),									
									array(
										'label' => 'Laboratorio',
										'icon' => 'icon-chevron-right',
										'url' => '/peas/headquarter/admin_laboratorio',
										'visible' => !Yii::app()->user->isGuest && Yii::app()->user->checkAccess('peas')
									),
									array(
										'label' => 'Reporte',										
