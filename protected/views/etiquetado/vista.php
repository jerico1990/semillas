...
<div class="row-fluid well">
	<div class='row-fluid'>      
      <div class="form">
         ...
         <div class="row-fluid">			 				
			   <div class="span12"><?php echo $form->textFieldRow($model,'peso_total',array()); ?></div>			
			</div> 
            ...
            <div class="span12">
               <div class="form-actions">																							 
                  <div class="row buttons">
                     <?php $this->widget('bootstrap.widgets.TbButton', array('type'=>'success','htmlOptions'=>array('class'=>'span3',),'buttonType'=>'submit', 'label'=>$model->isNewRecord ? 'Crear' : 'Emitir Acta')); ?>
                  </div>   
               </div>
            </div>
         </div>       
