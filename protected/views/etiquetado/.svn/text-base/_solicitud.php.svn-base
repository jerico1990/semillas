...
<div class="row-fluid well">
	<div class='row-fluid'>      
      <div class="form">
         ...
         ?>
         <div class="row-fluid">			
            <div class="span4"><?php echo $form->datepickerRow($model,'fecha_solicitud_etiquetado',
                                                                   array(																						 
                                                                       ...
                                                                       'showAnim'=>'fold',))); ?></div>
            <div class="span4"><?php echo $form->textFieldRow($model,'hora_solicitud_etiquetado',array('data-format'=>'hh:mm A','class'=>'input-small','value'=>''));	?></div>
         </div>
         <div class="row-fluid">
            <div class="span12">
