...
.well {
  ...
  -webkit-border-radius: 4px;
	...
	<body>
  	      ...
  	      <tr>
            <td class="bottom bigfont" width="20%"><div>'.$model->usera->ruc.'</div></td>
            <td class="bottom bigfont" colspan="4"><div>'.$model->usera->fullname.'</div></td>    
        	</tr>
					<tr>
   ...
   <p><strong>Resultados del análisis</strong>			</p></div>
      <div class="span9 well">
        ...
        <table width="100%" class="thin" cellspacing="0" cellpadding="0">
         ...
         <tr>
          <td class="bigfont" align="center">'.$laboratory->semilla_pura.'</td>
          <td class="bigfont" align="center">'.$laboratory->materia_inerte.'</td>
          <td class="bigfont" align="center">'.$laboratory->otras_semillas.'</td>
          <td class="bigfont" align="center">'.$laboratory->number_day.'</td>
          <td class="bigfont" align="center">'.$laboratory->plantulas_normales.'</td>
          <td class="bigfont" align="center">'.$laboratory->semillas_duras.'</td>
          <td class="bigfont" align="center">'.$laboratory->semillas_frescas.'</td>
          <td class="bigfont" align="center">'.$laboratory->plantulas_anormales.'</td>
          <td class="bigfont" align="center">'.$laboratory->semillas_muertas.'</td>
          <td class="bigfont" align="center">'.$laboratory->contenido_humedad.'</td>
         </tr>
        </table>    
          <table width="100%" cellpadding="2">
        <tr>
       ...
       <tr>
		...
		<div class="span9 well">'.$laboratory->observacion.'</div>
            	<div >
