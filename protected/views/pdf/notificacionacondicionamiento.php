...
<body>
	<table width="100%" cellpadding="2">
		<tr>
			...
			<strong>Notificacion para la realización de inspección de acondicionamiento de semillas</strong></div></td>
	  </tr>
      <tr>
	...
	<table width="100%" cellpadding="2">
        <tr>
            <td width="15%"><div>Nombre del Productor</div></td>
            <td width="5%"><div>:</div></td>    
            <td width="80%"><div>'.$model->usera->legal_name.'</div></td>    
        </tr>
        <tr>
            <td width="15%"><div>N° de Registro del Productor</div></td>
            <td width="5%"><div>:</div></td>    
	...
	<table width="100%" cellpadding="2">
		...
		<tr>
    		<td width="100%"><div class="tab">
    		 <div align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Por la presente, le comunicamos que la  Inspección de acondicioinamiento de semillas de '.$model->crop->name.' inscrita con el expediente Nro. '.$model->form_number.', se realizara en día '.date('d-m-Y',strtotime($acondicionamiento->real_date)).' a horas '.date('h:m A',strtotime($acondicionamiento->real_time)).'. Por lo que deberá estar presente usted o un representante y cuando corresponda el agricultor multiplicador, en su planta de acondicionamiento a fin de cumplir con la inspección programada, en cumplimiento al artículo 19 del Reglamento Técnico de Certificación de Semillas (DS Nro. 033-2005-AG).</div>
    		</div></td>
		</tr>
		<tr>
		    <td width="100%"><div ></div></td>
