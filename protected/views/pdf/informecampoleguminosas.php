...
.well {
  ...
  -webkit-border-radius: 4px;
     -moz-border-radius: 4px;
		...
		<body>
			<div style="font-size: 1.2em; text-align: center; font-weight: bold;">Informe de Inspección de campo de multiplicación de semillas de Leguminosas</div>
     ...
     <table width="100%" cellpadding="2">
				<tr>    			
					<td class="top smallfont" width="25%"><div>Cantidad de semilla/Ha</div></td>
					<td class="top smallfont" width="25%"><div>Nro de plantas/Ha</div></td>
					<td class="top smallfont" colspan="2"><div>Aspecto General</div></td>					
				</tr>
        <tr>  
        ...
        <tr>    			
					<td class="top smallfont" colspan="4"><div>Etapa / Estado fenológico del cultivo</div></td>
				</tr>
				<tr>
			    <td class="bottom" width="20%">   
      		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
          		<tr>
            		<td width="80%"><div class="smallfont">Emergencia: </div></td>
           			<td width="20%"><div class="left">'.$inspection->leg_emergencia_fecha.'</div></td>
		          </tr>
    		    </table>
					</td>
			   	<td class="bottom" width="20%">   
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
          		<tr>
									<td width="35%"><div class="smallfont">Floracion %: </div></td>
									<td width="65%"><div class="left">'.$inspection->leg_floracion_fecha.' - '.$inspection->leg_floracion.'</div></td>
							</tr>
						</table>
					</td>
          <td class="bottom" width="20%">   
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
          		<tr>
									<td width="80%"><div class="smallfont">Llenado de grano: </div></td>
									<td width="20%"><div class="left">'.$inspection->leg_llenado_grano.'</div></td>
							</tr>
						</table>
					</td>
          <td class="bottom" width="20%">   
      		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
          		<tr>
            		<td width="80%"><div class="smallfont">Fecha de cosecha: </div></td>
           			<td width="20%"><div class="left">'.$inspection->leg_fecha_cosecha.'</div></td>
		          </tr>
    		    </table>
					</td>
				</tr>       
      ...
      <table width="100%" cellpadding="2">
        ...
        <tr>
         <td class="bottom" width="20%">   
      		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
          		<tr>
            		<td width="80%"><div class="smallfont">Surcos (m)</div></td>
           			<td width="20%"><div class="left">'.$inspection->leg_distanciamiento_surcos.'</div></td>
		          </tr>
    		    </table>
					</td>
           <td class="bottom" width="20%">   
      		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
          		<tr>
            		<td width="80%"><div class="smallfont">Mata (m)</div></td>
           			<td width="20%"><div class="left">'.$inspection->leg_mata.'</div></td>
		          </tr>
    		    </table>
					</td>
          <td class="bottom" width="20%">   
      		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
          		<tr>
            		<td width="80%"><div class="smallfont">Campo Comercial (m)</div></td>
           			<td width="20%"><div class="left">'.$inspection->leg_campo_comercial.'</div></td>
		          </tr>
    		    </table>
					</td>
			   	<td class="bottom" width="20%">   
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
          		<tr>
									<td width="80%"><div class="smallfont">Otro Especie (m)</div></td>
									<td width="20%"><div class="left">'.$inspection->leg_otra_especie.'</div></td>
							</tr>
						</table>
					</td>
          <td class="bottom" width="20%">   
          		...
          		<tr>
									...
									<td width="20%"><div class="left">'.$inspection->leg_otro_cultivar.'</div></td>
							</tr>
						</table>
					</td>
        </tr>
      ...
      <table width="100%" cellpadding="2">
				<tr>    			
					<td class="top smallfont" width="50%"><div>Presencia de malezas</div></td>
          <td class="top smallfont" width="50%"><div>Presencia de plagas</div></td>
				</tr>
        <tr>
          <td class="bottom bigfont" width="50%"><div>'.$inspection->leg_presencia_maleza.'</div></td>
          <td class="bottom bigfont" width="50%"><div>'.$inspection->leg_presencia_plagas.'</div></td>
        </tr>
        <tr>    			
					<td class="top smallfont" width="50%"><div>Plantas Otras especies</div></td>
          <td class="top smallfont" width="50%"><div>Plantas fuera de tipo</div></td>
				</tr>
        <tr>
          <td class="bottom bigfont" width="50%"><div>'.$inspection->leg_plantas_otras_especies.'</div></td>
          <td class="bottom bigfont" width="50%"><div>'.$inspection->leg_plantas_fuera_tipo.'</div></td>
        </tr>
      </table>    
		</div>
