	...
	<table width="100%" cellpadding="2">
		...
		<tr>
    		<td width="100%"><div class="tab">
    		 <div align="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Por la presente, le comunicamos que el muestreo de semillas de '.$model->crop->name.' con Lote Nro. '.$muestreo->codigo_lote.', se realizara en día '.date('d-m-Y',strtotime($muestreo->date_real)).' a horas '.date('h:m A',strtotime($muestreo->time_real)).'. Por lo que deberá estar presente usted o un representante y cuando corresponda el agricultor multiplicador, en su planta de acondicionamiento a fin de cumplir con la inspección programada, en cumplimiento al artículo 19 del Reglamento Técnico de Certificación de Semillas (DS Nro. 033-2005-AG).</div>
    		</div></td>
		</tr>
		<tr>
		    <td width="100%"><div ></div></td>
