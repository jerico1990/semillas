  ...
  <div><br>
   <p><strong>Datos del Lote de Semillas</strong>			</p></div>
      ...
      <div><br><p><strong>Tipo de analisis solicitado</strong></p></div>
        ...
        <table width="100%" cellpadding="2">     
        <tr>
		        <td class="top bottom smallfont" width="20%"><div>Germinación:</div></td>        
            <td class="top bottom smallfont" width="20%"><div>Humedad:</div></td>
            <td class="top bottom smallfont" width="20%"><div>Pureza:</div></td>
            <td class="top bottom smallfont" width="20%"><div>Determinación de otras especies:</div></td>
            <td width="20%"><div></div></td>             
        </tr>        
        </table>
			</div>
