  ...
  -webkit-border-radius: 4px;
	...
	<body>
      ...
      <div><br><p><strong>Instalaciones equipos y semillas</strong></p></div>
        ...
        <tr>
            <td class="bottom bigfont" width="33%"><div>.</div></td>
            <td class="bottom bigfont" width="33%"><div>.</div></td>
            <td class="bottom bigfont" width="33%"><div>.</div></td>
        </tr>        
        </table>
      ...
      <div><br><p><strong>Identificacion del lote de semillas</strong></p></div>
        ...
        <tr>
         <td class="bottom bigfont" width="20%"><div>Cultivar:</div></td>        
            <td class="bottom bigfont" width="20%"><div>Categoria:</div></td>
            <td class="bottom bigfont" width="20%"><div>Nro de Control:</div></td>
            <td class="bottom bigfont" width="20%"><div>Productor de Semilla:</div></td>
            <td width="20%"><div></div></td>             
        </tr>        
        </table>
			</div>
