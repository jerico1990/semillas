...
.well {
  ...
  -webkit-border-radius: 4px;
     -moz-border-radius: 4px;
		...
		<body>
			<div style="font-size: 1.2em; text-align: center; font-weight: bold;">Informe de Inspección de campo de multiplicación de semillas de Maiz</div>
     ...
     <table width="100%" cellpadding="2">
      		  ...
      		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
          		<tr>
            		<td width="80%"><div class="smallfont">Emergencia: </div></td>
           			<td width="20%"><div class="left">'.date('d-m-Y',strtotime($inspection->maiz_emergencia_fecha)).'</div></td>
		          </tr>
    		    </table>
					</td>
			   	<td class="bottom" width="20%">   
          		...
          		<tr>
									...
									<td width="65%"><div class="left">'.date('d-m-Y',strtotime($inspection->maiz_floracion_fecha)).' - '.$inspection->maiz_floracion.'</div></td>
							</tr>
						</table>
					</td>
          <td class="bottom" width="20%">   
          		...
          		<tr>
									...
									<td width="20%"><div class="left">'.$inspection->maiz_llenado_grano.'</div></td>
							</tr>
						</table>
					</td>
          <td class="bottom" width="20%">   
      		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
          		<tr>
            		<td width="80%"><div class="smallfont">Fecha de cosecha: </div></td>
           			<td width="20%"><div class="left">'.date('d-m-Y',strtotime($inspection->maiz_fecha_cosecha)).'</div></td>
		          </tr>
    		    </table>
					</td>
				</tr>       
      		  ...
      		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
          		<tr>
            		<td width="80%"><div class="smallfont">Surcos (m)</div></td>
           			<td width="20%"><div class="left">'.$inspection->maiz_distanciamiento_surcos.'</div></td>
		          </tr>
    		    </table>
					</td>
           <td class="bottom" width="20%">   
      		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
          		<tr>
            		<td width="80%"><div class="smallfont">Mata (m)</div></td>
           			<td width="20%"><div class="left">'.$inspection->maiz_mata.'</div></td>
		          </tr>
    		    </table>
					</td>
          <td class="bottom" width="20%">   
      		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
          		<tr>
            		<td width="80%"><div class="smallfont">Campo Comercial (m)</div></td>
           			<td width="20%"><div class="left">'.$inspection->maiz_campo_comercial.'</div></td>
		          </tr>
    		    </table>
					</td>
			   	<td class="bottom" width="20%">   
          		...
          		<tr>
									...
									<td width="20%"><div class="left">'.$inspection->maiz_otra_especie.'</div></td>
							</tr>
						</table>
					</td>
          <td class="bottom" width="20%">   
          		...
          		<tr>
									...
									<td width="20%"><div class="left">'.$inspection->maiz_otro_cultivar.'</div></td>
							</tr>
						</table>
					</td>
        </tr>
      ...
      <table width="100%" cellpadding="2">
        ...
        <tr>
          <td class="bottom bigfont" width="50%"><div>'.$inspection->maiz_presencia_maleza.'</div></td>
          <td class="bottom bigfont" width="50%"><div>'.$inspection->maiz_presencia_plagas.'</div></td>
        </tr>
        <tr>    			
					<td class="top smallfont" width="50%"><div>Plantas de otra especie</div></td>
          <td class="top smallfont" width="50%"><div>Plantas fuera de tipo</div></td>
				</tr>
        <tr>
          <td class="bottom bigfont" width="50%"><div>'.$inspection->maiz_plantas_otras_especies.'</div></td>
          <td class="bottom bigfont" width="50%"><div>'.$inspection->maiz_plantas_fuera_tipo.'</div></td>
        </tr>
      </table>    
		</div>
