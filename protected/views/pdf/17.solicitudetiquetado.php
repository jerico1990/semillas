...
<html>
    ...
    <div style="text-align: center; font-style: italic;">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="35%" rowspan="2" bgcolor="#FFFFFF" class="bigfont">
            <strong>
              Solicitud:
            </strong>
						Verificación del envasado y etiquetado de lote de semillas
          </td>
        </tr>
        <tr>
  ...
  <body>
    <div style="text-align:justify;">
      ...
      <blockquote>
        <p>
          Por la presente solicito a Usted, se sirva disponer a quien corresponda la verificación del envasado y etiquetado del lote de semillas, para lo cual declaro la siguiente información:
        </p>
      </blockquote>
    </div>
    <div>
    ...
    <div class="span9 well">
      <table width="100%" cellpadding="2" cellspacing="5">
        <tr>
          ...
          <td class="top smallfont" colspan="4" >
            <div>
              Razón Social
            </div>
          </td>
        ...
        <tr>
          ...
          <td class="bottom bigfont" colspan="4">
            <div>
              '.$model->
              usera->
              legal_name.'
  ...
  <div>
	...
	<p>
      <strong>
        Datos del Lote de Semillas a Evaluar
      </strong>
      </p>
  </div>
  <div class="span9 well">
    <table width="100%" cellpadding="2">
      ...
      <tr>
        ...
        <td class="top smallfont" width="25%">
          <div>
            Nro. de Control del Lote de Semillas
          </div>
        </td>
        <td class="top smallfont" width="25%">
          <div>
      ...
      <tr>
        ...
        <td class="top smallfont" width="25%">
          <div>
            Lugar de Ubicación del Lote de Semillas
          </div>
        </td>
  ...
  <div>
	...
	<p>
      <strong>
        Datos del número de etiquetas solicitadas
      </strong>
      </p>
  </div>
  <div class="span9 well">
  ...
  <div>
	...
	<p>
      <strong>
        Datos para la programación del Muestreo
      </strong>
      </p>
  </div>
  <div class="span9 well">
...
-->
  ...
  <div style="text-align: left; font-style: italic;" class="bigfont">
    Declaro bajo juramento que los datos consignados en la presente solicitud son verídicos, que conozco la normatividad vigente para la producción y certificación de semillas, la reglamentación específica de semillas de la especie a multiplicar y me someto a las sanciones legales que se impongan por contravenir la Ley General de Semillas y sus Reglamentos. Asimismo me comprometo a proporcionar toda la información necesaria y facilitar el acceso al INIA para el proceso de certificación.
  </div>
