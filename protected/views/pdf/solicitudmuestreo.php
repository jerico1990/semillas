...
<div style="text-align: center; font-style: italic;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <p></p></td>
      <td width="15%"></td>
      <td width="35%" rowspan="2" bgcolor="#FFFFFF" class="bigfont"><strong>Solicitud</strong>: Muestreo de Lote de semillas</td>
    </tr>
    <tr>
...
<div style="text-align:justify;">
 			 ...
 			 <blockquote>
 			  <p>Por la presente solicito a Usted, se sirva disponer a quien corresponda el Muestreo del lote de semillas, para lo cual declaro la siguiente información:</p>
		   </blockquote>
 			</div>
...
<tr>
	...
	<div><br>
	<p><strong>Datos del Lote de Semillas a Muestrear</strong></p>
</div>
<div class="span9 well">
<table width="100%" cellpadding="2">
...
<tr>
    ...
    <td class="top smallfont" width="25%"><div>Nro. de Control del Lote de Semillas</div></td>
    <td class="top smallfont" width="25%"><div>Nro. de envases</div></td>
    <td class="top smallfont" width="25%"><div>Peso de cada envase (kg)</div></td>
    <td class="top smallfont" width="25%">Peso del Lote</td>
</tr>
<tr>
    <td class="bottom bigfont" width="25%"><div>'.$muestreo->codigo_lote.'</div></td>
    <td class="bottom bigfont" width="25%"><div>'.$muestreo->nro_envases.'</div></td>
    <td class="bottom bigfont" width="25%"><div>'.$muestreo->peso_envase.'</div></td>
    <td class="bottom bigfont" width="25%"><div>'.$muestreo->peso_total.'</div></td>
</tr>
<tr>
    ...
    <td class="top smallfont" width="25%"><div>Lugar de Ubicación del Lote de Semillas</div></td>        
</tr>
<tr>
    ...
    <td class="bottom bigfont" width="25%"><div>'.$acondicionamiento->address.'</div></td>
</tr>
</table>
</div>
	<div><br>
	<p><strong>Datos para la programación del Muestreo</strong></p>
</div>
<div class="span9 well">
<table width="100%" cellpadding="2">
<tr>
...
<tr>
    <td class="bottom bigfont" width="20%"><div>'.$muestreo->date_proposed.'</div></td>
    <td class="bottom bigfont" width="20%"><div>'.$muestreo->time_proposed.'</div></td>
    <td colspan="3"><div>.</div></td>
</tr>
</table>
</div>
