...
$categoria=Maestro::model()->find('codigo=:codigo and codigo_detalle=:codigo_detalle',
                                  array(':codigo'=>'005',':codigo_detalle'=>$model->category));
...
<div style="text-align: center; font-style: italic;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <p></p></td>
      <td width="15%"></td>
      <td width="35%" rowspan="2" bgcolor="#FFFFFF" class="bigfont"><strong>Solicitud</strong>: Inspección de campo de multiplicación en proceso de certificación de semillas</td>
    </tr>
    <tr>
...
<table width="100%" cellpadding="2">
<tr>
    <td class="top smallfont" width="20%"><div>Nº de Inspección</div></td>
    <td class="top smallfont" width="20%"><div>Fecha Propuesta</div></td>
    <td class="top smallfont" width="20%"><div>Hora Propuesta</div></td>    
    <td colspan="2"><div></div></td>
</tr>
<tr>
    <td class="bottom bigfont" width="20%"><div>'.$inspection->inspection_number.'</div></td>
    <td class="bottom bigfont" width="20%"><div>'.date("d-m-Y", strtotime($inspection->proposed_date)).'</div></td>
    <td class="bottom bigfont" width="20%"><div>'.date("h:m A",strtotime($inspection->proposed_time)).'</div></td>
    <td colspan="2"><div>.</div></td>
</tr>
</table>
</div>
