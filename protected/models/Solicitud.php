...
class Solicitud extends CFormModel
{
   ...
   {
      return array(			
		     array('tipo_documento,var_registro,var_ruc,var_razon_social,var_dni,
			   var_nombres,var_apellidos,var_correo,district_id,
		     ...
		     array('var_fax', 'length', 'max'=>20),
		     array('var_telefono', 'length', 'max'=>12),
