...
*/
function Md(a,b,c){var d=fd(b[1]),e=fd(c[1]),f=(e-d)/2;b=fd(c[0]-b[0])/2;d=Math.sin(f)*Math.sin(f)+Math.sin(b)*Math.sin(b)*Math.cos(d)*Math.cos(e);return 2*a.a*Math.atan2(Math.sqrt(d),Math.sqrt(1-d))};var Nd=new function(){this.a=6370997};var Od="object"==typeof Proj4js,Pd={le:"degrees",Bg:"ft",Mg:"m"},Qd={};Qd.degrees=2*Math.PI*Nd.a/360;Qd.ft=0.3048;Qd.m=1;function Rd(a){this.Ua=a.code;this.Jb=a.units;this.g=r(a.extent)?a.extent:null;this.d=r(a.axisOrientation)?a.axisOrientation:"enu";this.Hd=r(a.global)?a.global:!1;this.f=null}Rd.prototype.ba=h("g");Rd.prototype.a=function(){return Qd[this.Jb]};function Sd(a){return a.d}function Td(a,b){var c={units:a.units,axisOrientation:a.axis};zc(c,b);Rd.call(this,c);this.e=a;this.c=null}
E(Td,Rd);Td.prototype.a=function(){var a=this.e.to_meter;r(a)||(a=Qd[this.Jb]);return a};Td.prototype.b=function(a,b){if("degrees"==this.Jb)return a;null===this.c&&(this.c=Ud(this,Vd({code:"EPSG:4326",extent:null})));var c=[b[0]-a/2,b[1],b[0]+a/2,b[1],b[0],b[1]-a/2,b[0],b[1]+a/2],c=this.c(c,c,2),d=Md(Nd,c.slice(0,2),c.slice(2,4)),c=Md(Nd,c.slice(4,6),c.slice(6,8)),d=(d+c)/2;"ft"==this.Jb&&(d/=0.3048);return d};function Wd(a){return a.e}var Xd={},Yd={},Zd={};
...
O.prototype.W=function(){if(we){var a=this.e();a&&!r(this.b)?this.b=p.navigator.geolocation.watchPosition(y(this.la,this),y(this.ia,this),this.f()):!a&&r(this.b)&&(p.navigator.geolocation.clearWatch(this.b),this.b=void 0)}};var we="geolocation"in p.navigator;
...
O.prototype.getProjection=O.prototype.ha;O.prototype.s=function(){return this.get("speed")};O.prototype.getSpeed=O.prototype.s;O.prototype.e=function(){return this.get("tracking")};O.prototype.getTracking=O.prototype.e;O.prototype.f=function(){return this.get("trackingOptions")};O.prototype.getTrackingOptions=O.prototype.f;O.prototype.g=function(a){this.k("projection",a)};O.prototype.setProjection=O.prototype.g;O.prototype.d=function(a){this.k("tracking",a)};O.prototype.setTracking=O.prototype.d;
O.prototype.i=function(a){this.k("trackingOptions",a)};O.prototype.setTrackingOptions=O.prototype.i;function xe(a,b){Sc.call(this);this.L=a;this.state=b}E(xe,Sc);xe.prototype.a=function(){return v(this).toString()};xe.prototype.e=h("L");function ye(a,b,c,d,e){xe.call(this,a,b);this.f=c;this.b=new Image;null!==d&&(this.b.crossOrigin=d);this.d={};this.c=null;this.g=e}E(ye,xe);ye.prototype.ca=function(a){if(r(a)){var b=v(a);if(b in this.d)return this.d[b];a=uc(this.d)?this.b:this.b.cloneNode(!1);return this.d[b]=a}return this.b};ye.prototype.a=h("f");ye.prototype.i=function(){this.state=3;Ja(this.c,Lc);this.c=null;I(this,"change")};
...
R.prototype.getCenter=R.prototype.a;R.prototype.g=function(a){var b=this.a(),c=this.F();return[b[0]-c*a[0]/2,b[1]-c*a[1]/2,b[0]+c*a[0]/2,b[1]+c*a[1]/2]};R.prototype.ha=function(){return this.get("projection")};R.prototype.getProjection=R.prototype.ha;R.prototype.F=function(){return this.get("resolution")};R.prototype.getResolution=R.prototype.F;function Bi(a){var b=a.b,c=Math.log(b/a.e)/Math.log(2);return function(a){return b/Math.pow(2,a*c)}}R.prototype.c=function(){return this.get("rotation")};
R.prototype.getRotation=R.prototype.c;function Ci(a){var b=a.b,c=Math.log(b/a.e)/Math.log(2);return function(a){return Math.log(b/a)/Math.log(2)/c}}m=R.prototype;m.O=function(){return this};function Di(a){var b=a.a(),c=a.ha(),d=a.F();a=a.c();return{center:b.slice(),projection:r(c)?c:null,resolution:d,rotation:r(a)?a:0}}m.Oe=function(){var a,b=this.F();if(r(b)){var c,d=0;do{c=this.Ca(this.b,d);if(c==b){a=d;break}++d}while(c>this.e)}return a};
...
dc);ec=Mn;Jj=1}else if(dc instanceof Nm)ec=Qm(dc,Ha.g),Jj=dc.opacity,jh=dc.xOffset,kh=dc.yOffset;else throw Error("Unsupported symbolizer: "+dc);if(null===ec)Ij=!0;else{var as=Math.floor(ec.width/2),bs=Math.floor(ec.height/2),Pn=ec.width*Ha.b,Qn=ec.height*Ha.b,cs=jh*Ha.b,ds=kh*Ha.b;uf.save();uf.setTransform(1,0,0,1,-as,-bs);uf.globalAlpha=Jj;eh=0;for(Kn=Jn.length;eh<Kn;++eh)if(fh=Jn[eh],"hidden"!==fh.bb)for(ee=v(fh),gh=Ha.a[ee],Ha.a[ee]=r(gh)?[Math.max(gh[0],Pn),Math.max(gh[1],Qn)]:[Pn,Qn],Ha.e[ee]=
[jh*Ha.b,kh*Ha.b],Ha.c=[Math.max(Ha.c[0],Ha.a[ee][0]+2*Math.abs(cs)),Math.max(Ha.c[1],Ha.a[ee][1]+2*Math.abs(ds))],hh=fh.D(),Kj=hh instanceof Hm?[hh]:hh.t,ih=0,Ln=Kj.length;ih<Ln;++ih)Lj=Kj[ih],vf=[Lj.get(0),Lj.get(1),0],Ke(Ha.f,vf,vf),uf.drawImage(ec,Math.round(vf[0]+jh),Math.round(vf[1]+kh),ec.width,ec.height);uf.restore();Ij=!1}}else if(sb instanceof $l){var wc=ch,Rn=dh,Pj=sb,fc=wc.d,mh=void 0,Sn=void 0,nh=void 0,oh=void 0,fe=void 0,ph=void 0,Qj=void 0,qh=void 0,Tn=void 0,Rj=void 0,Sj=void 0,wf=
...
0,Un=Rj.length;wf<Un;++wf)if(Sj=Rj[wf],gc[0]=Sj[0],gc[1]=Sj[1],Ke(wc.f,gc,gc),0===wf)he[0]=NaN,he[1]=NaN,fc.moveTo(gc[0],gc[1]);else if(ge[0]=Math.round(gc[0]),ge[1]=Math.round(gc[1]),ge[0]!==he[0]||ge[1]!==he[1])fc.lineTo(gc[0],gc[1]),he[0]=ge[0],he[1]=ge[1];fc.stroke()}else if(sb instanceof Pl){var Wn=ch,Xn=dh,Ia=Wn.d,rh=sb.strokeColor,Yn=sb.da,sh=sb.U,xf=sb.fillColor,th=sb.na,ie=void 0,yf=void 0,Tj=void 0,uh=void 0,Uj=void 0,zf=void 0,Vj=void 0,Zn=void 0,Wj=void 0,$n=void 0,Xj=void 0,Yj=void 0,
Af=void 0,ao=void 0,Zj=void 0,hc=[NaN,NaN,0],je=[NaN,NaN],ke=[NaN,NaN];rh&&(Ia.strokeStyle=rh,Yn&&(Ia.lineWidth=Yn),Ia.lineCap="round",Ia.lineJoin="round");xf&&(Ia.fillStyle=xf);Ia.beginPath();yf=0;for(Tj=Xn.length;yf<Tj;++yf)if(Zj=Xn[yf],"hidden"!==Zj.bb)for(uh=Zj.D(),Uj=uh instanceof Lm?[uh]:uh.t,zf=0,Vj=Uj.length;zf<Vj;++zf)if(Zn=Uj[zf],Wj=Zn.a,$n=Wj.length,0<$n){Xj=Wj[0].p();Af=0;for(ao=Xj.length;Af<ao;++Af)if(Yj=Xj[Af],hc[0]=Yj[0],hc[1]=Yj[1],Ke(Wn.f,hc,hc),0===Af)ke[0]=NaN,ke[1]=NaN,Ia.moveTo(hc[0],
...
tb.font=Ua.fontWeight+" "+Ua.fontSize+"px "+Ua.fontFamily;tb.globalAlpha=Ua.opacity;tb.textAlign="center";tb.textBaseline="middle";var fo=!1;r(Ua.strokeColor)&&(fo=!0,tb.strokeStyle=Ua.strokeColor,tb.lineWidth=Ua.da);for(var Bf=0,es=co.length;Bf<es;++Bf)if(ak=co[Bf],"hidden"!==ak.bb)for(var bk=Pm(ak.D()),ck=0,fs=bk.length;ck<fs;++ck)id=bk[ck],Ke(bo.f,id,id),fo&&(Ua.U!==Ua.opacity&&(tb.globalAlpha=Ua.U),tb.strokeText(eo[Bf],id[0],id[1]),Ua.U!==Ua.opacity&&(tb.globalAlpha=Ua.opacity)),tb.fillText(eo[Bf],
id[0],id[1])}if(Bj=Ij)break}Bj||zc(Ea,Cb);var gs=ha.a,hs=ha.c,is=ha.e;for(vc in Ea)bc=Ea[vc],Bm(this.c,vc)?pf=this.c.get(vc)[0]:(pf=this.d.cloneNode(!1),pf.getContext("2d").drawImage(V,(A.a-bc.x)*k[0],(bc.y-A.b)*k[1]),Cm(this.c,vc,[pf,gs,hs,is])),aa.drawImage(pf,k[0]*(bc.x-A.a),k[1]*(A.b-bc.y));this.Q=x;this.K=B;this.q||(this.q=!0,a.$a.push(y(this.Lf,this)))}}};m.Lf=function(){for(;this.c.ga()>this.c.d;)this.c.pop();this.q=!1};var Vm=128;function Wm(a,b){qk.call(this,0,b);this.b=Ig("CANVAS");this.b.height=a.clientHeight;this.b.width=a.clientWidth;this.b.className="ol-unselectable";Mg(a,this.b);this.c=!0;this.f=[a.clientHeight,a.clientWidth];this.g=this.b.getContext("2d")}E(Wm,qk);Wm.prototype.jc=function(a){return a instanceof Bk?new ym(this,a):a instanceof Ck?new zm(this,a):a instanceof om?new Um(this,a):null};Wm.prototype.tc=h("b");
Wm.prototype.Gc=function(a){if(null===a)this.c&&(Th(this.b,!1),this.c=!1);else{var b=a.size;if(this.f[0]!=b[0]||this.f[1]!=b[1])this.b.width=b[0],this.b.height=b[1],this.f=b;var c=this.g;c.clearRect(0,0,b[0],b[1]);rk(a);var b=a.pa,d=a.Ec,e=a.B.resolution,f,g,k,l,n;f=0;for(g=d.length;f<g;++f)if(k=d[f],l=sk(this,k),n=b[v(k)],n.visible&&!(1!=n.bc||e>=n.maxResolution||e<n.minResolution)&&(l.Ja(a,n),k=l.ca(),null!==k))if(l=l.ad(),c.globalAlpha=n.opacity,0===a.B.rotation){n=l[13];var q=k.width*l[0],s=k.height*
...
(Xm(this.target,b),Ge(this.d,b));kk(a.attributions,f.d);lk(a,g)}};function $m(a,b){var c=Ig("DIV");c.style.position="absolute";Ym.call(this,a,b,c);this.d=!0;this.i=1;this.e=0;this.c={}}E($m,Ym);
...
function uo(a,b){var c=a.a,d=b.a,e=v(b);if(e in a.f)e=a.f[e],c.bindBuffer(34962,e.buffer),qn(e.lc,function(a,b){var e=d.slice(a,b);c.bufferSubData(34962,a,new Float32Array(e))}),e.lc.clear();else{var f=c.createBuffer();c.bindBuffer(34962,f);c.bufferData(34962,new Float32Array(d),b.d);var g=new nn;b.b.push(g);a.f[e]={ea:b,buffer:f,lc:g}}}
...
m.jc=function(a){return a instanceof Ck?new so(this,a):a instanceof Bk?new jo(this,a):a instanceof xn?new Co(this,a):null};m.A=function(){var a=this.a;mc(this.f,function(a){Pa(a.ea.b,a.lc)});a.isContextLost()||(mc(this.f,function(b){a.deleteBuffer(b.buffer)}),mc(this.g,function(b){a.deleteProgram(b)}),mc(this.i,function(b){a.deleteShader(b)}),this.b.forEach(function(b){null===b||a.deleteTexture(b.ta)}));Ko.H.A.call(this)};
...
function Mo(a,b){var c=v(b);if(c in a.i)return a.i[c];var d=a.a,e=d.createShader(b.S());d.shaderSource(e,b.ja());d.compileShader(e);return a.i[c]=e}m.Gf=function(a){a.T();this.r=this.q=null;this.f={};this.i={};this.g={};this.b.clear();this.n=0;mc(this.d,function(a){a.g()})};m.vf=function(){Lo(this);ik(this.e)};function Lo(a){a=a.a;a.activeTexture(33984);a.blendFuncSeparate(770,771,1,771);a.disable(2884);a.disable(2929);a.disable(3089)}
...
X.prototype.setSize=X.prototype.la;X.prototype.re=function(a){this.k("target",a)};X.prototype.setTarget=X.prototype.re;X.prototype.se=function(a){this.k("view",a)};X.prototype.setView=X.prototype.se;X.prototype.ia=function(){var a=this.Fc(),a=r(a)?u(a)?document.getElementById(a):a:null;null===a?this.la(void 0):(a=Qh(a),this.la([a.width,a.height]))};function Li(a,b){++a.e;try{b.call(void 0)}finally{if(0===--a.e&&a.s){var c=a.f;ng(c);c.Tc()}}}
...
So.prototype.getElement=So.prototype.g;So.prototype.f=function(){return this.get("map")};So.prototype.getMap=So.prototype.f;So.prototype.i=function(){return this.get("position")};So.prototype.getPosition=So.prototype.i;So.prototype.e=function(){return this.get("positioning")};So.prototype.getPositioning=So.prototype.e;m=So.prototype;m.Ve=function(){Kg(this.b);var a=this.g();null!=a&&Jg(this.b,a)};
m.bf=function(){null!==this.c&&(Ng(this.b),Lc(this.c),this.c=null);var a=this.f();null!=a&&(this.c=H(a,"postrender",this.Ff,!1,this),To(this),Jg(this.r?a.v:a.eb,this.b))};m.Ff=function(){To(this)};m.gf=function(){To(this)};m.hf=function(){To(this)};m.ge=function(a){this.k("element",a)};So.prototype.setElement=So.prototype.ge;So.prototype.d=function(a){this.k("map",a)};So.prototype.setMap=So.prototype.d;So.prototype.o=function(a){this.k("position",a)};So.prototype.setPosition=So.prototype.o;
So.prototype.q=function(a){this.k("positioning",a)};So.prototype.setPositioning=So.prototype.q;
function To(a){var b=a.f(),c=a.i();if(r(b)&&b.Vb()&&r(c)){var c=Xi(b,c),d=b.c(),b=a.b.style,e=a.e();if("bottom-right"==e||"center-right"==e||"top-right"==e){""!==a.a.Ha&&(a.a.Ha=b.left="");var f=Math.round(d[0]-c[0])+"px";a.a.Ka!=f&&(a.a.Ka=b.right=f)}else{""!==a.a.Ka&&(a.a.Ka=b.right="");f=0;if("bottom-center"==e||"center-center"==e||"top-center"==e)f=Qh(a.b).width/2;f=Math.round(c[0]-f)+"px";a.a.Ha!=f&&(a.a.Ha=b.left=f)}if("bottom-left"==e||"bottom-center"==e||"bottom-right"==e)""!==a.a.Lc&&(a.a.Lc=
b.top=""),c=Math.round(d[1]-c[1])+"px",a.a.hc!=c&&(a.a.hc=b.bottom=c);else{""!==a.a.hc&&(a.a.hc=b.bottom="");d=0;if("center-left"==e||"center-center"==e||"center-right"==e)d=Qh(a.b).height/2;c=Math.round(c[1]-d)+"px";a.a.Lc!=c&&(a.a.Lc=b.top=c)}a.a.visible||(Th(a.b,!0),a.a.visible=!0)}else a.a.visible&&(Th(a.b,!1),a.a.visible=!1)};var Uo;Uo=!1;var Vo=wb();Vo&&(-1!=Vo.indexOf("Firefox")||-1!=Vo.indexOf("Camino")||-1!=Vo.indexOf("iPhone")||-1!=Vo.indexOf("iPod")||-1!=Vo.indexOf("iPad")||-1!=Vo.indexOf("Android")||-1!=Vo.indexOf("Chrome")&&(Uo=!0));var Wo=Uo;var Xo=Db?"webkitfullscreenchange":"mozfullscreenchange";function Yo(){var a=zg().a,b=a.body;return!!b.webkitRequestFullScreen||!!b.mozRequestFullScreen&&a.mozFullScreenEnabled}function Zo(){var a=zg().a;return!!a.webkitIsFullScreen||!!a.mozFullScreen};function $o(a){a=r(a)?a:{};this.b=r(a.className)?a.className:"ol-full-screen";var b=Fg("A",{href:"#fullScreen","class":this.b+"-"+Zo()});H(b,["click","touchend"],this.c,!1,this);H(p.document,Xo,this.e,!1,this);b=Fg("DIV",{"class":this.b+" ol-unselectable "+(Yo()?"":"ol-unsupported")},b);Ei.call(this,{element:b,target:a.target});this.g=r(a.keys)?a.keys:!1}E($o,Ei);
...
m.A=function(){jp.H.A.call(this);Jc(this.d,["touchstart","mousedown"],this.ie,!1,this);ip(this.a);kp&&this.c.releaseCapture();this.d=this.target=null};function lp(a){r(a.e)||(a.e=Uh(a.target));return a.e}
...
function qp(a,b,c){var d=Qg(zg(a.c));b+=d.x-a.f.x;c+=d.y-a.f.y;a.f=d;a.Bb+=b;a.Cb+=c;b=op(a,a.Bb);a=pp(a,a.Cb);return new xg(b,a)}m.If=function(a){var b=qp(this,0,0);a.clientX=this.clientX;a.clientY=this.clientY;rp(this,a,b.x,b.y)};function rp(a,b,c,d){a.rd&&lp(a)?a.target.style.right=c+"px":a.target.style.left=c+"px";a.target.style.top=d+"px";I(a,new np("drag",a,b.clientX,b.clientY,b,c,d))}
function op(a,b){var c=a.b,d=isNaN(c.left)?null:c.left,c=isNaN(c.width)?0:c.width;return Math.min(null!=d?d+c:Infinity,Math.max(null!=d?d:-Infinity,b))}function pp(a,b){var c=a.b,d=isNaN(c.top)?null:c.top,c=isNaN(c.height)?0:c.height;return Math.min(null!=d?d+c:Infinity,Math.max(null!=d?d:-Infinity,b))}function np(a,b,c,d,e,f,g,k){kb.call(this,a);this.clientX=c;this.clientY=d;this.d=e;this.left=r(f)?f:b.Bb;this.top=r(g)?g:b.Cb;this.b=b;this.a=!!k}E(np,kb);function sp(a){a=r(a)?a:{};this.b=void 0;this.c=tp;this.i=!1;this.e=null;a=r(a.className)?a.className:"ol-zoomslider";a=Fg("DIV",a+" ol-unselectable",Fg("DIV",a+"-thumb ol-unselectable"));null!==this.e&&(Ja(this.e,Lc),this.e=null);var b=new jp(a.childNodes[0]);this.e=[H(b,["drag","end"],this.r,void 0,this)];this.g=b;H(a,["touchend","click"],this.o,!1,this);Ei.call(this,{element:a})}E(sp,Ei);var tp=0;sp.prototype.setMap=function(a){sp.H.setMap.call(this,a);null===a||ik(a)};
...
vp.prototype.e=function(a){this.k("value",a)};vp.prototype.setValue=vp.prototype.e;vp.prototype.g=function(a){this.k("valueAsNumber",a)};vp.prototype.setValueAsNumber=vp.prototype.g;vp.prototype.f=function(a){this.k("checked",a)};vp.prototype.setChecked=vp.prototype.f;vp.prototype.o=function(){"checkbox"===this.a.type||"radio"===this.a.type?this.f(this.a.checked):(this.e(this.a.value),this.g(this.a.valueAsNumber))};vp.prototype.i=function(){this.a.checked=this.b()?"checked":void 0};
vp.prototype.r=function(){this.a.value=this.d()};vp.prototype.q=function(){this.a.value=this.c()};function wp(a,b){this.x=a;this.y=b}E(wp,xg);wp.prototype.$=function(){return new wp(this.x,this.y)};wp.prototype.scale=xg.prototype.scale;wp.prototype.add=function(a){this.x+=a.x;this.y+=a.y;return this};function xp(a){a=r(a)?a:{};Ui.call(this);this.n=r(a.condition)?a.condition:Si;this.a=this.d=void 0;this.G=0}E(xp,Ui);xp.prototype.yc=function(a){var b=a.map,c=b.c();a=a.f();a=new wp(a[0]-c[0]/2,c[1]/2-a[1]);c=Math.atan2(a.y,a.x);a=Math.sqrt(a.x*a.x+a.y*a.y);var d=b.a().O(),e=Di(d);Wi(b);r(this.d)&&Ki(b,d,e.rotation-(c-this.d));this.d=c;r(this.a)&&Ni(b,d,this.a*(e.resolution/a));r(this.a)&&(this.G=this.a/a);this.a=a};
xp.prototype.Sb=function(a){var b=a.map,c=b.a().O(),d=Di(c),e=this.G-1;Li(b,function(){var a=d.rotation,a=c.ic(a,0);Ki(b,c,a,void 0,void 0);a=d.resolution;a=c.Ca(a,0,e);Ni(b,c,a,void 0,400)});this.G=0;return!0};xp.prototype.Tb=function(a){return this.n(a)?(this.a=this.d=void 0,!0):!1};function yp(a){a=r(a)?a:{};this.f=r(a.condition)?a.condition:Qi;this.d=r(a.addCondition)?a.addCondition:Si;this.b={};this.a={};this.c=r(a.layerFilter)?a.layerFilter:null}E(yp,Ji);
yp.prototype.tb=function(a){if(this.f(a)){var b=a.map,c=b.Ma().Nb();null===this.c||(c=Ka(c,this.c));var d=!this.d(a),e=this;b.Gd({layers:c,pixel:a.f(),success:function(a){var g=c,k=v(b);k in e.a||(e.a[k]={map:b,layers:{}});for(var l=0,n=a.length;l<n;++l){var q=g[l],s=v(q),x=e.a[k].layers[s];r(x)||(x=new om({source:new $k({parser:null}),style:q instanceof om?q.c:null}),x.Oc=!0,b.ud(x),e.a[k].layers[s]=x,e.b[s]={});var t,A;ma(q.d)&&(t=[],A=[]);var B=a[l],w=B.length,z=[],J=[],D=e.b[s],S=D;if(d){for(var V in D)r(A)&&
...
m.add=function(a){if(a.e||a.d){var b=this.getMonth()+a.d+12*a.e,c=this.getFullYear()+Math.floor(b/12),b=b%12;0>b&&(b+=12);var d;a:{switch(b){case 1:d=0!=c%4||0==c%100&&0!=c%400?28:29;break a;case 5:case 8:case 10:case 3:d=30;break a}d=31}d=Math.min(d,this.getDate());this.a.setDate(1);this.a.setFullYear(c);this.a.setMonth(b);this.a.setDate(d)}a.a&&(a=new Date((new Date(this.getFullYear(),this.getMonth(),this.getDate(),12)).getTime()+864E5*a.a),this.a.setDate(1),this.a.setFullYear(a.getFullYear()),
...
!r(a)||u(a.featureType);this.C="http://www.opengis.net/gml";this.j={"http://www.opengis.net/wfs":{FeatureCollection:function(a,b){Y(this,a,b)}},"http://www.opengis.net/gml":{_inherit:function(a){var b;r(this.srsName)||(b=this.srsName=a.getAttribute("srsName"));r(this.axisOrientation)||(this.axisOrientation=null!=b?Sd(te(b)):"enu")},name:function(a,b){b.name=Z(a)},featureMember:function(a,b){Y(this,a,b)},featureMembers:function(a,b){Y(this,a,b)},GeometryCollection:function(a,b){var e=[];this.j[this.C]._inherit.apply(this,
[a,e,b]);Y(this,a,e);b.geometry={type:"geometrycollection",N:e}},geometryMember:function(a,b){Y(this,a,b)},MultiPoint:function(a,b){var e=[];this.j[this.C]._inherit.apply(this,[a,e,b]);Y(this,a,e);b.geometry={type:"multipoint",N:e}},pointMember:function(a,b){Y(this,a,b)},MultiLineString:function(a,b){var e=[];this.j[this.C]._inherit.apply(this,[a,e,b]);Y(this,a,e);b.geometry={type:"multilinestring",N:e}},lineStringMember:function(a,b){Y(this,a,b)},MultiPolygon:function(a,b){var e=[];this.j[this.C]._inherit.apply(this,
[a,e,b]);Y(this,a,e);b.geometry={type:"multipolygon",N:e}},polygonMember:function(a,b){Y(this,a,b)},Point:function(a,b){var e=[];this.j[this.C]._inherit.apply(this,[a,e,b]);Y(this,a,e);e={type:"point",coordinates:e[0][0]};ia(b)?b.push(e):b.geometry=e},LineString:function(a,b){var e=[];this.j[this.C]._inherit.apply(this,[a,e,b]);Y(this,a,e);e={type:"linestring",coordinates:e[0]};ia(b)?b.push(e):b.geometry=e},Polygon:function(a,b){var e={$d:null,Ac:[]};this.j[this.C]._inherit.apply(this,[a,e,b]);Y(this,
a,e);e.Ac.unshift(e.$d);e={type:"polygon",coordinates:e.Ac};ia(b)?b.push(e):b.geometry=e},LinearRing:function(a,b){var e=[];this.j[this.C]._inherit.apply(this,[a,e,b]);Y(this,a,e);ia(b)?b.push(e):b.geometry={type:"linearring",coordinates:e[0]}},coordinates:function(a,b){for(var e=Z(a).replace(this.R.ua,""),e=e.replace(this.R.od,","),f=a.getAttribute("cs")||",",g=a.getAttribute("ts")||this.R.Ib,g=e.split(g),k=g.length,l=Array(k),n=0;n<k;++n)e=La(g[n].split(f),parseFloat),"en"===this.axisOrientation.substr(0,
2)?l[n]=e:2===e.length?l[n]=e.reverse():3===e.length&&(l[n]=[e[1],e[0],e[2]]);b.push(l)},coord:function(a,b){var e={};0===b.length&&b.push([]);Y(this,a,e);r(e.z)?b.push([e.x,e.y,e.z]):b[0].push([e.x,e.y])},X:function(a,b){b.x=parseFloat(Z(a))},Y:function(a,b){b.y=parseFloat(Z(a))},Z:function(a,b){b.z=parseFloat(Z(a))}}};this.d={"*":function(a,b){var e,f=a.localName||a.nodeName.split(":").pop();b.features?this.Uf||-1===Ga(this.featureType,f)?f===this.featureType&&(e="_typeName"):e="_typeName":0===
a.childNodes.length||1===a.childNodes.length&&3===a.firstChild.nodeType?this.extractAttributes&&(e="_attribute"):e="_geometry";e&&this.j[this.featureNS][e].apply(this,[a,b])},_typeName:function(a,b){var e={properties:{}};Y(this,a,e);e.name&&(e.properties.name=e.name);var f=new N(e.properties);if(e=e.geometry)e=Mq(this,{geometry:e}),r(e)&&f.Aa(e);e=a.getAttribute("fid")||this.getAttributeNS(a,this.C,"id");null!==e&&(f.Ea=e);b.features.push(f)},_geometry:function(a,b){this.geometryName||(this.geometryName=
a.nodeName.split(":").pop());Y(this,a,b)},_attribute:function(a,b){var e=a.localName||a.nodeName.split(":").pop();b.properties[e]=Z(a)}};r(this.featureNS)&&(this.j[this.featureNS]=this.d);this.a={"http://www.opengis.net/gml":{featureMember:function(a){var b=this.createElementNS("gml:featureMember");$(this,"_typeName",a,this.featureNS,b);return b},MultiPoint:function(a){var b=this.createElementNS("gml:MultiPoint");a=a.t;for(var e=0,f=a.length;e<f;++e)$(this,"pointMember",a[e],null,b);return b},pointMember:function(a){var b=
this.createElementNS("gml:pointMember");$(this,"Point",a,null,b);return b},MultiLineString:function(a){var b=this.createElementNS("gml:MultiLineString");a=a.t;for(var e=0,f=a.length;e<f;++e)$(this,"lineStringMember",a[e],null,b);return b},lineStringMember:function(a){var b=this.createElementNS("gml:lineStringMember");$(this,"LineString",a,null,b);return b},MultiPolygon:function(a){var b=this.createElementNS("gml:MultiPolygon");a=a.t;for(var e=0,f=a.length;e<f;++e)$(this,"polygonMember",a[e],null,
...
this.setAttributeNS(f,null,"srsName",this.srsName);return b},_attribute:function(a){var b=this.createElementNS("feature:"+a.name,this.featureNS);b.appendChild(this.createTextNode(a.value));return b}};r(this.featureNS)&&(this.a[this.featureNS]=this.c);Cp.call(this)}E(Lq,Cp);
...
Lq.prototype.Qa=function(a,b,c){!0===c&&!0===this.f&&(this.featureType=null,delete this.j[this.featureNS],delete this.a[this.featureNS],this.featureNS=null);this.featureNS||(a.namespaceURI in this.j||a.parentNode.namespaceURI!=this.C||!/^(.*:)?featureMembers?$/.test(a.parentNode.nodeName))||(this.featureType=a.nodeName.split(":").pop(),this.j[a.namespaceURI]=this.d,this.a[a.namespaceURI]=this.c,this.featureNS=a.namespaceURI,this.f=!0);return Cp.prototype.Qa.apply(this,[a,b])};
